...
Pretty much: 
  ...
  Awww, look mate: viewing a user's max crockeritude image
    Y'know I am on Genghis Khan's page
    Too right his rating is 10/10
    But at the end of the day I reckon I should see "an image that I'll figure out later"

  Awww, look mate: viewing a user's min crockeritude image
    Y'know I am on Tom Cruise's page
    Yeah nah his rating is 0/10
    But at the end of the day I reckon I should see "a different image that I'll figure out later"
